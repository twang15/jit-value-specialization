...
bool
CoalesceBlocks(MIRGraph &graph);

bool
DCEConditionals(MIRGraph &graph);
...
#ifdef DEBUG
void
CheckInstructionsWithConstantOperands(MIRGraph &graph);
#else
static inline void CheckInstructionsWithConstantOperands(MIRGraph &graph)
{ }
#endif
