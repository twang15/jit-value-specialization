...
struct IonOptions
{
    ...
    // Toggles whether loop inversion is performed
    //
    // Default: false
    bool linv;

    // Toggles whether loop inversion analysis is performed
    //
    // Default: false
    bool linvA;

    // Toggles whether OverFlow Tests analysis is performed
    //
    // Default: false
    bool ota;

    // Toggles whether block coalescing is performed
    //
    // Default: false
    bool bcoal;

    // Toggles whether dead code elimination for conditionals is performed
    //
    // Default: false
    bool dcec;

    // Toggles whether parameter specialization is performed
    //
    // Default: false
    bool ps;

    // Toggles whether constant propagation is performed.
    //
    // Default: false
    bool cp;

    // Toggles whether bounds check elimination.
    //
    // Default: false
    bool bce;
